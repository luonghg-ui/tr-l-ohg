...
(async () => {
    const urls = [
        "https://internal.thuocsi.vn/backend/core/activity/v1/activity?targetID=109&target=MEDX.GHKGEQ1P",
        "https://internal.thuocsi.vn/backend/core/activity/v1/activity?targetID=109&objectId=MEDX.GHKGEQ1P",
        "https://internal.thuocsi.vn/backend/core/activity/v1/activity?targetID=109&search=MEDX.GHKGEQ1P"
    ];
    for(let u of urls) {
