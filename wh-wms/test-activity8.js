...
(async () => {
    const urls = [
        "https://internal.thuocsi.vn/backend/core/activity/v1/activity?targetID=109&target=MEDX.GHKGEQ1P&offset=0&limit=20",
        "https://internal.thuocsi.vn/backend/core/activity/v1/activity?targetID=109&target=sku:MEDX.GHKGEQ1P&offset=0&limit=20",
        "https://internal.thuocsi.vn/backend/core/activity/v1/activity?targetId=109&target=MEDX.GHKGEQ1P&offset=0&limit=20"
    ];
    for(let u of urls) {
