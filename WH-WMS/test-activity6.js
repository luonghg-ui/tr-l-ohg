...
(async () => {
    const urls = [
        "https://internal.thuocsi.vn/backend/core/activity/v1/target?codes=wms-sku-location",
        "https://internal.thuocsi.vn/backend/core/activity/v1/target?codes=wms-sku-location&target=MEDX.GHKGEQ1P",
        "https://internal.thuocsi.vn/backend/core/activity/v1/target?codes=wms-sku-location&target=sku:MEDX.GHKGEQ1P",
        "https://internal.thuocsi.vn/backend/core/activity/v1/target?codes=wms-sku-location&target=MEDX.GHKGEQ1P-HN",
        "https://internal.thuocsi.vn/backend/core/activity/v1/target?target=MEDX.GHKGEQ1P"
    ];
    for(let u of urls) {
